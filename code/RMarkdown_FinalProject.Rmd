...
knitr::include_graphics("/Users/amykeay/Documents/masters degree 🧠/PSY6422 Data Analysis and Visualisation 📊/Uncorking-The-Secrets-of-Wine-Popularity/project/heading_1.png")
...
# Research Questions 
The aim of this project is to determine whether certain characteristics of wine including Type, ABV, Body and Acidity, have an effect on popularity (operationalised on a 1-to-5 scale, higher ratings represent more popular wine). 
...
## Basic Bar Plots ##
I created a series of bar graphs that showed individually the distributions of specific wine Characteristics across each wine in the data.The bar plots I made are: 
...
ggplot(Wine_Final, aes(x = as.factor(WineID), y = ABV, fill = Type)) +
...
ggplot(Wine_Final, aes(x = as.factor(WineID), y = Body, fill = Type)) +
  geom_col(color = "black") +
...
ggplot(Wine_Final, aes(x = as.factor(WineID), y = Acidity, fill = Type)) +
  geom_col(color = "black") +
...
ggplot(Wine_Final, aes(x = as.factor(WineID), y = overall_rating, fill = Type)) +
  geom_col(color = "black") +
...
## Final Visualisation ##
For my final visualisation I wanted to combine the four bar plots above into one comprehensive plot that showed ABV Percentage, Body, Acidity and Overall Rating of each individual wine. 

## Additional Visualisation ##
I then created an additional visualisation (just because I thought it would be fun and interesting) showing the favourite wines of the countries included in this data plotted on a map. 
